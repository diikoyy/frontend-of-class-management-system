...
export class EditStudentModuleModal extends Component {
	constructor(props) {
		super(props);
		this.state = { stumodus: [] };
								...
								<Form onSubmit={this.handleSubmit}>
									<Form.Group controlId="Number">
										...
										<Form.Control
											...
											required
											disabled
											defaultValue={this.props.stumodunum}
											placeholder="Number"
										/>
									</Form.Group>
									...
									<Form.Group controlId="StudentID">
										...
										<Form.Control
											...
											required
											disabled
											defaultValue={this.props.stumodusid}
									...
									<Form.Group controlId="StudentName">
										...
										<Form.Control
											...
											required
											disabled
											defaultValue={this.props.stumodusname}
									...
									<Form.Group controlId="ModuleID">
										...
										<Form.Control
											...
											name="ModuleID"
											required
											defaultValue={this.props.stumodumid}
									...
									<Form.Group controlId="ModuleName">
										...
										<Form.Control
											...
											name="ModuleName"
											required
											defaultValue={this.props.stumodumname}
